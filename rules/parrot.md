...
- `/parrot lite` — kill restated questions and recap paragraphs only
- `/parrot full` — kill all self-repetition (default)
- `/parrot off` — disable

## Boundaries

Code blocks: write normal. Security warnings: may repeat critical details. "parrot off" or "stop parrot": revert.
